// NavigationBar from Material You
// git clone -b feature-navigationBar https://github.com/johnsonmh/flutter.git
              ...
              for (int i = 0; i < destinations.length; i++)
                Expanded(
                  child: SelectableAnimatedBuilder(
                    ...
                    builder: (BuildContext context, Animation<double> animation) => NavigationBarDestinationInfo(
                      destinationNumber: i,
          ...
          children: <Widget>[
            ...
            StatusTransitionWidgetBuilder(
              ...
              builder: (BuildContext context, Widget? child) =>
                  animation.isForwardOrCompleted ? selectedIconWidget : unselectedIconWidget,
            ),
          ],
        );
      },
      buildLabel: (BuildContext context) => Padding(
...
class NavigationBarDestinationLayout extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => DestinationLayoutAnimationBuilder(
        builder: (BuildContext context, Animation<double> animation) => CustomMultiChildLayout(
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: StatusTransitionWidgetBuilder(
        animation: animation,
        builder: (BuildContext context, Widget? child) => SelectableAnimatedBuilder(
          isSelected: animation.isForwardOrCompleted,
          duration: const Duration(milliseconds: 100),
          alwaysDoFullAnimation: true,
          builder: (BuildContext context, Animation<double> fadeAnimation) => FadeTransition(
...
class NavigationBarDestinationInfo extends InheritedWidget {
  ...
  static NavigationBarDestinationInfo of(BuildContext context) {
    final NavigationBarDestinationInfo? result =
        context.dependOnInheritedWidgetOfExactType<NavigationBarDestinationInfo>();
    assert(
      result != null,
...
class _NavigationBarDestinationLayoutDelegate extends MultiChildLayoutDelegate {
  _NavigationBarDestinationLayoutDelegate({required this.animation}) : super(relayout: animation);
  ...
  @override
  bool shouldRelayout(_NavigationBarDestinationLayoutDelegate oldDelegate) => oldDelegate.animation != animation;
}
