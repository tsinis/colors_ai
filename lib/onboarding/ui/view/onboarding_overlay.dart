...
class OnboardingOverlay extends StatelessWidget {
  ...
  const OnboardingOverlay({required this.size, required this.length, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<OnboardingBloc, OnboardingState>(
      builder: (_, OnboardingState state) => state.maybeWhen(
        doneSuccess: () => const SizedBox.shrink(key: TestKeys.disappearedOnboard),
        orElse: () => Stack(
          children: <Widget>[
            IgnorePointer(
              child: ColoredBox(
